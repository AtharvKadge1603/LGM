...
- Includes a REST API and TradingView browser extension integration.
...
## TradingView integration (extension)
...
2. Load `tradingview_extension/` as an unpacked extension in Chrome.
3. Open TradingView charts and read the AI prediction badge in the top-right.

> Pine Script cannot directly call arbitrary external endpoints. The extension bridge is the practical way to surface model outputs in TradingView UI.
